...
def wrapper_function_2(lst_1, lst_2, header_1, header_2):
  for item_1 in lst_1:
    for item_2 in lst_2:
...
if (user == 1):
  ...
  wrapper_function_2(dictionary[headers[2]],dictionary[headers[1]],2,1)
  ...
  wrapper_function_2(dictionary[headers[0]],dictionary[headers[1]],0,1)
# 3-d
# elif (user == 7):
# print('\n'+headers[0]+'-'+headers[1]+'\t\t\t\t\t'+headers[4])
# wrapper_function_2(dictionary[headers[0]],dictionary[headers[1]],0,1)
  ...
  wrapper_function_2(dictionary[headers[0]],dictionary[headers[3]],0,3)

elif (user == 9):
  print('\n'+headers[1]+'-'+headers[3]+'\t\t\t\t\t'+headers[4])
  wrapper_function_2(dictionary[headers[1]],dictionary[headers[3]],1,3)
# 3-d
# elif (user == 10):
# print('\n'+headers[1]+'-'+headers[3]+'\t\t\t\t\t'+headers[4])
# wrapper_function_2(dictionary[headers[1]],dictionary[headers[3]],1,3)
